...
function CargoStatusModal({ 
  ...
  const [isCargoSectionExpanded, setIsCargoSectionExpanded] = useState(true); // New state for cargo section
  ...
  const otherCargoCount = getOtherCargoCount();
        ...
        >
          ...
          {isCargoSectionExpanded ? (
            <span className="cargo-section-count">
              {unileverCargoCount} Unilever • {otherCargoCount} Other
            </span>
          ) : (
            <div className="cargo-section-summary">
              <span className="cargo-summary-item unilever">
                <span className="cargo-count">{unileverCargoCount}</span> Unilever
              </span>
              <span className="cargo-summary-divider">•</span>
              <span className="cargo-summary-item other">
                <span className="cargo-count">{otherCargoCount}</span> Other
              </span>
              <span className="cargo-summary-divider">•</span>
